const heroes = [
    {
        name: "매튜-기병",
        type: 3,
        stats: ["히어로 : 버프5개이상일경우 전투시 받는피해-10%","히어로 : 버프5개이상일경우 전투시 입히는피해+10%", "스트라이크 마스터 : 공격하여 전투진입시 받는피해감소 -10%", "스트라이크 마스터 : 공격 받아 전투 진입시 입히는피해 +10%", "호감도 총합 32", 
                "호감도 총합 52","호감도 총합 72","호감도 총합 92","15%","35%","30%","15%"],
        ability: 0,
        classes: [
            {
                name: "파이터[공격 9 / 생명 36]",
    ...
    },
    {
        ...
        type: 3,
        stats: ["히어로 : 버프5개이상일경우 전투시 받는피해-10%","히어로 : 버프5개이상일경우 전투시 입히는피해+10%", 
                "쉐도우 : 공격하여 전투진입시 받는피해감소 -10%", "쉐도우 : 공격 받아 전투 진입시 입히는피해 +10%", "호감도 총합 32", 
                "호감도 총합 52","호감도 총합 72","호감도 총합 92","15%","35%","30%","15%"],
        ability: 0,
         classes: [
            {
